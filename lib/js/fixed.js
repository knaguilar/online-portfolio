...
//about section
var about = {
	img: "images/mobile/fall2015-compressed.jpg",
...
var projects = [{
		...
		img: "images/mobile/neighborhood-compressed.jpg",
		...
		url: "https://knaguilar.github.io/neighborhood-map/"
	},
	{
		name: "Frogger Arcade Game Clone",
		img: "images/mobile/arcade-compressed.png",
		...
		url: "https://knaguilar.github.io/arcade-frogger-game/"
	},
	{
		name: "Stumble Upon Lyfe",
		img: "images/mobile/sul-compressed.png",
		...
		url: "stumbleuponlyfe.wordpress.com"
	},
	{
		name: "Feed Reader Testing",
		img: "images/mobile/feedtesting-compressed.png",
...
projects.display = function() {
	...
	for (var project = 0; project < projects.length; project++) {
		...
		web = '<a class="btn btn-primary link" href="'+ projects[project].url+'" role="button">View Project</a>';
